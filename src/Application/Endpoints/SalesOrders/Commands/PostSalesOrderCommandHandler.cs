...
{
    public class PostSalesOrderCommandHandler : IRequestHandler<PostSalesOrderCommand, EndpointResult<SalesOrderViewModel>>
    {
        private readonly IRequestValidator<PostSalesOrderCommand> _requestValidator;
        private readonly IRepositoryWrapper _repository;
        private readonly IMapper _mapper;
        private readonly IAutoGenerateNumberService _autoGenerateNumberService;

        public PostSalesOrderCommandHandler(IRequestValidator<PostSalesOrderCommand> requestValidator, IRepositoryWrapper repository, IMapper mapper, IAutoGenerateNumberService autoGenerateNumberService)
        {
        ...
        public async Task<EndpointResult<SalesOrderViewModel>> Handle(PostSalesOrderCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                salesOrder.OrderNumber = _autoGenerateNumberService.GenerateCodeWithUtcDate("ORD", (lastSalesOrder is null) ? null : lastSalesOrder.OrderNumber, 4);
